...
var getMining = function(template) {
    web3.wsh.getMining(function(e, res) {
        if(!e && res) {
            web3.wsh.getHashrate(function(e, res) {
                if(!e) {
...
Template['elements_nodeInfo'].onCreated(function(){
    ...
    // CHECK FOR NETWORK
    web3.wsh.getBlock(0, function(e, res){
        if(!e){
    ...
    // CHECK SYNCING
    this.syncFilter = web3.wsh.isSyncing(function(error, syncing) {
        if(!error) {
