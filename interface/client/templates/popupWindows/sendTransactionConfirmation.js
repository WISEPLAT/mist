...
Template['popupWindows_sendTransactionConfirmation'].onCreated(function () {
    ...
    this.autorun(function () {
        ...
        if (data) {
            ...
            if (!data.gasPrice) {
                web3.wsh.getGasPrice(function (e, res) {
                    if (!e) {
            ...
            if (data.to) {
                web3.wsh.getCode(data.to, function (e, res) {
            ...
            if (data.from) {
                web3.wsh.getCode(data.from, function (e, res) {
                    if (!e && res && res.length > 2) {
            ...
            web3.wsh.estimateGas(estimateData, function (e, res) {
...
Template['popupWindows_sendTransactionConfirmation'].helpers({
    ...
    */
    'totalAmount': function () {
        var amount = WshTools.formatBalance(this.value, '0,0.00[0000000000000000]', 'wise');
    ...
    */
    'estimatedFee': function () {
        ...
        if (gas && this.gasPrice) {
            return WshTools.formatBalance(new BigNumber(gas, 10).times(new BigNumber(this.gasPrice, 10)), '0,0.0[0000000] unit', 'wise');
        }
    },
    /**
    Calculates the provided gas amount in wise
    ...
    */
    'providedGas': function () {
        ...
        if (gas && this.gasPrice) {
            return WshTools.formatBalance(new BigNumber(gas, 10).times(new BigNumber(this.gasPrice, 10)), '0,0.0[0000000]', 'wise');
        }
    },
    /**
...
Template['popupWindows_sendTransactionConfirmation'].events({
    /**
    Gets the new provided gas in wise amount and calculates the resulting providedGas
