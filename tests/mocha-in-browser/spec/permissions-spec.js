...
describe('Permissions', function () {
    ...
    describe('web3.wsh.accounts', function () {

        it('should return an array [sync]', function () {
            var accounts = web3.wsh.accounts;
    ...
    describe('web3.wsh.coinbase', function () {
        ...
        it('should be empty [async, batch request]', function (done) {
            ...
            var batch = web3.createBatch();
            batch.add(web3.wsh.getCoinbase.request(callback));
            batch.add(web3.wsh.getCoinbase.request(callback));
            batch.execute();
        });
    ...
    describe('web3 parameter validation', function () {
        ...
        it('shouldn\'t allow RegExp (possible XSS)', function () {
            ...
            expect(function () { web3.wsh.sendTransaction({ from: add, to: add, data: new RegExp('') }); }).to.throw('Payload, or some of its content properties are invalid. Please check if they are valid HEX with \'0x\' prefix.');
        });
    });
