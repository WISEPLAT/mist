...
(function () {
    ...
    WiseplatProvider.prototype = Object.create(EventEmitter.prototype);
    WiseplatProvider.prototype.constructor = WiseplatProvider;
     ...
     */
    WiseplatProvider.prototype._addResponseCallback = function(payload, callback) {
     ...
     */
    WiseplatProvider.prototype._reconnectCheck = function() {
        var _this = this;
    ...
    /**
     ...
     @method connect
     */
    WiseplatProvider.prototype._connect = function(payload, callback) {
        postMessage({
            type: 'create'
        });
    };
    ...
    /**
     ...
     @method send
     @param {Object} payload    example: {id: 1, jsonrpc: '2.0', 'method': 'wsh_someMethod', params: []}
     @param {Function} callback the callback to call
     */
    // TODO transform to: send(method, params, callback)
    WiseplatProvider.prototype.send = function send(payload, callback) {
    ...
    // TODO set real wiseplat provider
    // window.wiseplat = new WiseplatProvider();


    // For backwards compatibility of web3.currentProvider;
    WiseplatProvider.prototype.sendSync = function () {
        return {jsonrpc: '2.0', error: {"code": -32603, message: 'Sync calls are not anymore supported in Mist :\\'}};
    };
    WiseplatProvider.prototype.sendAsync = WiseplatProvider.prototype.send;
    WiseplatProvider.prototype.isConnected = function () {
        return true;
    };
    window.web3 = {
        currentProvider: new WiseplatProvider()
    };
})();
