...
!define GROUPNAME "Wiseplat"
!define HELPURL "https://github.com/wiseplat/mist/releases/issues"
!define UPDATEURL "https://github.com/wiseplat/mist/releases"
!define ABOUTURL "https://wiseplat.org"
...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\Wiseplat"
...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "Gwsh incoming peers (TCP:30373)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\Gwsh\unpacked\gwsh.exe" "" "" "Wiseplat" 30373 "" "" ""
    #SimpleFC::AdvAddRule "Gwsh outgoing peers (TCP:30373)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\Gwsh\unpacked\gwsh.exe" "" "" "Wiseplat" "" 30373 "" ""
    #SimpleFC::AdvAddRule "Gwsh UDP discovery (UDP:30373)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\Gwsh\unpacked\gwsh.exe" "" "" "Wiseplat" "" 30373 "" ""
